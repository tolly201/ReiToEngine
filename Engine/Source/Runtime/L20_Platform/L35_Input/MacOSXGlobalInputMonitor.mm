...
// #include "MacOSXGlobalInputMonitor.h"
// @implementation NSGlobalInputMonitor
// - (id)init {
//     self = [super init];
//     return self;
// }
...
//     return a;
// }
// MacOSXGlobalInputMonitor::MacOSXGlobalInputMonitor() {
//     // 创建并启动事件监听器
//     cocoaInputMonitor = [[NSGlobalInputMonitor alloc] init];
...
//     // }
// }
// KEY_CODE_KEYBOARD MacOSXGlobalInputMonitor::MapKeyCode(uint16_t nsKeyCode) {
