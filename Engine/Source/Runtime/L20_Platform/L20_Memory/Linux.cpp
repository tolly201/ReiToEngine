...
void RT_Platform_SYSZeroMemory(void* pMem, u64 uiSize) { memset(pMem, 0, uiSize); }

void RT_Platform_SYSCopyMemory(void* pDest, const void* pSrc, u64 uiSize) { memcpy(pDest, pSrc, uiSize); }

void RT_Platform_SYSMoveMemory(void* pDest, const void* pSrc, u64 uiSize) { memmove(pDest, pSrc, uiSize); }

void RT_Platform_SYSSetMemory(void* pMem, u8 value, u64 uiSize) { memset(pMem, value, uiSize); }
#endif
