#ifndef PLATFORM_RHI_RENDER_STRUCTS_H
#define PLATFORM_RHI_RENDER_STRUCTS_H
...
struct IndiceBuffer {
    ...
    IndiceBuffer(uint32_t* _indices, size_t _size, bool _isLine) : indices(_indices), size(_size), isLine(_isLine) {}
};
