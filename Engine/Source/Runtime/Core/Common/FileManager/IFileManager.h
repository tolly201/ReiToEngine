...
public:
	...
	virtual uint32_t Copy( const char* Dest, const char* Src, bool Replace=1, bool EvenIfReadOnly=0, bool Attributes=0, ECopyResult* Progress = nullptr, EFileRead ReadFlags=FILEREAD_None, EFileWrite WriteFlags=FILEWRITE_None)=0; // utility
...
private:
	...
	virtual uint32_t CopyWithProgress(const char* InDestFile, const char* InSrcFile, bool ReplaceExisting, bool EvenIfReadOnly, bool Attributes, ECopyResult* Progress, EFileRead ReadFlags, EFileWrite WriteFlags) = 0;
